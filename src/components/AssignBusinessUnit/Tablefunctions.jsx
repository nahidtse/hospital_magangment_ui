...
import RoleEditForm from "./AssignBUnitEditForm";
import SingleTableFunction from "./SingleTableFunction";
import AssignBUnitEditForm from "./AssignBUnitEditForm";
...
export const DATATABLE = (contacts, handlers) =>
    contacts.map((contact, id) => ({
        id: id + 1,
        fullname: contact.user?.full_name || "User name", 
        businessunit: contact.business_unit?.business_unit || "Business unit",
...
export const BasicTable = () => {
    ...
    const handleDeleteClick = async (contactId) => {
        try {
            const result = await fetch(`https://cserp.store/api/userbu/destroy/${contactId}`, {
                method: 'GET',
                headers: {
    ...
    if (showSingleData) {
        ...
        content = (
            ...
            existingAssignBUnitsData={contacts}
            />
        )
    }
    ...
    useEffect(() => {
        fetch('https://cserp.store/api/userbu')
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                <Card.Header className="justify-content-between">
                                    <div className='card-title'>Assign Business Unit List</div>
                                    <div className="prism-toggle">
                                        <Link to={`${import.meta.env.BASE_URL}assignbu/createform`} state={{contacts}}><button
                                            type="button"
