...
const MenuEdit = ({ setBusinessUnitList, setContactsData, passEditFormData, setPassingEditFormData }) => {
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <Form noValidate onSubmit={handleEditFormSubmit}>
                ...
                <Row className="mb-3">
                  <Form.Group as={Col} md="6" controlId="validationCustom01">
                    <Form.Label>Parent Name <span className='text-danger ms-1'>*</span></Form.Label>
                    <Form.Control
                      required
                      type="text"
                      className='border-dark'
