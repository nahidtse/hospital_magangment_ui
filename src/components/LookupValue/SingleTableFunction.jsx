                ...
                <Col xl={12}>
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <div className='card-title'>View Lookup Value</div>
                            ...
                            <Form>
                                <Row className="mb-3">
                                    <Form.Group as={Col} md="4" >
                                        <Form.Label>Lookup Value Name</Form.Label>
                                        <Form.Control
                                            type="text"
                                            className='border-dark readableInputBgColor'
                                            readOnly
                                            value={singleContactsData.lookup_value}
                                    ...
                                    <Form.Group as={Col} md="4" >
                                        ...
                                        <Form.Control
                                            ...
                                            className='border-dark readableInputBgColor'
                                            readOnly
                                            value={singleContactsData.lookup_code}
